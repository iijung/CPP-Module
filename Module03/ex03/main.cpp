...
/*   Updated: 2023/06/19 06:20:24 by minjungk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	test02(void)
{
	...
	std::cout << "AttackDamage(20): " << scav.getAttackDamage() << std::endl;
	std::cout << std::endl;
	scav.attack("sacv self");
	scav.takeDamage(scav.getAttackDamage());
	scav.beRepaired(scav.getAttackDamage());
	scav.guardGate();
	std::cout << "---------------- FragTrap ----------------" << std::endl;
	std::cout << "Name: " << frag.getName() << std::endl;
	std::cout << "HitPoints(100): " << frag.getHitPoints() << std::endl;
	std::cout << "EnergyPoints(100): " << frag.getEnergyPoints() << std::endl;
	std::cout << "AttackDamage(30): " << frag.getAttackDamage() << std::endl;
	std::cout << std::endl;
	frag.attack("frag self");
...
{
	DiamondTrap	diamond("Cla");

	std::cout << "---------------- PROFILE -----------------" << std::endl;
	std::cout << "Name: " << diamond.getName() << std::endl;
	std::cout << "HitPoints(100): " << diamond.getHitPoints() << std::endl;
	std::cout << "EnergyPoints(50): " << diamond.getEnergyPoints() << std::endl;
	std::cout << "AttackDamage(30): " << diamond.getAttackDamage() << std::endl;
	std::cout << "----------------- Attack -----------------" << std::endl;
	diamond.attack("self");
	std::cout << "----------------- Damage -----------------" << std::endl;
